...
# 
# # Create the leaflet map
# map_jenks <- leaflet(sd, options = leafletOptions(zoomControl = FALSE,  zoomSnap = 0.25)) |>
#   setView(va_lng, va_lat, zoom = 6.75) |>
#   addProviderTiles("CartoDB.Positron") |>
#   addPolygons(
...
knitr::include_url("data/geo/sd_count.html")
...
knitr::include_url("data/geo/sd_acres.html")
...
knitr::include_url("data/geo/sd_size.html")
